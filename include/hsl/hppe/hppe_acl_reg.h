...
union non_ip_udf0_ctrl_reg_u {
	a_uint32_t val;
	struct non_ip_udf0_ctrl_reg bf;
};
...
struct non_ip_udf1_ctrl_reg {
	a_uint32_t  udf1_base:2;
	a_uint32_t  _reserved0:6;
	a_uint32_t  udf1_offset:6;
	a_uint32_t  _reserved1:18;
};

union non_ip_udf1_ctrl_reg_u {
	a_uint32_t val;
	struct non_ip_udf1_ctrl_reg bf;
};
...
struct non_ip_udf2_ctrl_reg {
	a_uint32_t  udf2_base:2;
	a_uint32_t  _reserved0:6;
	a_uint32_t  udf2_offset:6;
	a_uint32_t  _reserved1:18;
};

union non_ip_udf2_ctrl_reg_u {
	a_uint32_t val;
	struct non_ip_udf2_ctrl_reg bf;
};
...
struct non_ip_udf3_ctrl_reg {
	a_uint32_t  udf3_base:2;
	a_uint32_t  _reserved0:6;
	a_uint32_t  udf3_offset:6;
	a_uint32_t  _reserved1:18;
};

union non_ip_udf3_ctrl_reg_u {
	a_uint32_t val;
	struct non_ip_udf3_ctrl_reg bf;
};
...
union ipv4_udf0_ctrl_reg_u {
	a_uint32_t val;
	struct ipv4_udf0_ctrl_reg bf;
};
...
union ipv4_udf1_ctrl_reg_u {
	a_uint32_t val;
	struct ipv4_udf1_ctrl_reg bf;
};
...
union ipv4_udf2_ctrl_reg_u {
	a_uint32_t val;
	struct ipv4_udf2_ctrl_reg bf;
};
...
union ipv4_udf3_ctrl_reg_u {
	a_uint32_t val;
	struct ipv4_udf3_ctrl_reg bf;
};
...
union ipv6_udf0_ctrl_reg_u {
	a_uint32_t val;
	struct ipv6_udf0_ctrl_reg bf;
};
...
union ipv6_udf1_ctrl_reg_u {
	a_uint32_t val;
	struct ipv6_udf1_ctrl_reg bf;
};
...
union ipv6_udf2_ctrl_reg_u {
	a_uint32_t val;
	struct ipv6_udf2_ctrl_reg bf;
};
...
union ipv6_udf3_ctrl_reg_u {
	a_uint32_t val;
	struct ipv6_udf3_ctrl_reg bf;
};
