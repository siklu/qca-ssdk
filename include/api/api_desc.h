...
#define SW_API_PT_VLAN_COUNTER_ENABLE_DESC \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_ENABLE, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_ENABLE, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_ENABLE, SW_PT_VLAN_COUNTER_EN, sizeof(fal_port_vlan_counter_en_t), SW_PARAM_PTR|SW_PARAM_IN, "enable"),

#define SW_API_PT_VLAN_COUNTER_STATUS_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_VLAN_COUNTER_STATUS_GET, SW_PT_VLAN_COUNTER_EN, sizeof(fal_port_vlan_counter_en_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),
