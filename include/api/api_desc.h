...
#define SW_API_PORT_QINQ_MODE_SET_DESC \
    ...
    SW_PARAM_DEF( SW_API_PORT_QINQ_MODE_SET, SW_PT_QINQMODE, sizeof(fal_port_qinq_mode_t), SW_PARAM_PTR|SW_PARAM_IN, "port qinq mode"),
...
#define SW_API_PORT_QINQ_MODE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_PORT_QINQ_MODE_GET, SW_PT_QINQMODE, sizeof(fal_port_qinq_mode_t), SW_PARAM_PTR|SW_PARAM_OUT, "port qinq mode"),
...
#define SW_API_PT_INGRESS_FILTER_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_INGRESS_FILTER_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_INGRESS_FILTER_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_INGRESS_FILTER_SET, SW_INGRESS_FILTER, sizeof(fal_ingress_filter_t), SW_PARAM_PTR|SW_PARAM_IN, "ingress filter mode"),

#define SW_API_PT_INGRESS_FILTER_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_INGRESS_FILTER_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_INGRESS_FILTER_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_INGRESS_FILTER_GET, SW_INGRESS_FILTER, sizeof(fal_ingress_filter_t), SW_PARAM_PTR|SW_PARAM_OUT, "ingress filter mode"),

#define SW_API_PT_INGRESS_DEFAULT_TAG_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_INGRESS_DEFAULT_TAG_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_INGRESS_DEFAULT_TAG_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_INGRESS_DEFAULT_TAG_SET, SW_PT_INGRESS_TAG, sizeof(fal_port_ingress_default_tag_t), SW_PARAM_PTR|SW_PARAM_IN, "ingress default tag"),

#define SW_API_PT_INGRESS_DEFAULT_TAG_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_INGRESS_DEFAULT_TAG_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_INGRESS_DEFAULT_TAG_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_INGRESS_DEFAULT_TAG_GET, SW_PT_INGRESS_TAG, sizeof(fal_port_ingress_default_tag_t), SW_PARAM_PTR|SW_PARAM_OUT, "ingress default tag"),

#define SW_API_PT_TAG_PROPOGATION_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_TAG_PROPOGATION_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_TAG_PROPOGATION_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_TAG_PROPOGATION_SET, SW_TAG_PROPOGATION, sizeof(fal_tag_propagation_t), SW_PARAM_PTR|SW_PARAM_IN, "tag propogation"),

#define SW_API_PT_TAG_PROPOGATION_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_TAG_PROPOGATION_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_TAG_PROPOGATION_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_TAG_PROPOGATION_GET, SW_TAG_PROPOGATION, sizeof(fal_tag_propagation_t), SW_PARAM_PTR|SW_PARAM_OUT, "tag propogation"),

#define SW_API_PT_TAG_EGVLANMODE_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_TAG_EGVLANMODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_TAG_EGVLANMODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_TAG_EGVLANMODE_SET, SW_EGRESS_MODE, sizeof(fal_egressmode_t), SW_PARAM_PTR|SW_PARAM_IN, "egress mode"),

#define SW_API_PT_TAG_EGVLANMODE_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_TAG_EGVLANMODE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_TAG_EGVLANMODE_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_TAG_EGVLANMODE_GET, SW_EGRESS_MODE, sizeof(fal_egressmode_t), SW_PARAM_PTR|SW_PARAM_OUT, "egress mode"),
...
#define SW_API_PT_VLAN_XLT_MISS_CMD_SET_DESC \
    ...
    SW_PARAM_DEF( SW_API_PT_VLAN_XLT_MISS_CMD_SET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_IN, "miss xlt cmd"),
...
#define SW_API_PT_VLAN_XLT_MISS_CMD_GET_DESC \
    ...
    SW_PARAM_DEF( SW_API_PT_VLAN_XLT_MISS_CMD_GET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_PTR|SW_PARAM_OUT, "miss xlt cmd"),

#define SW_API_PT_EGRESS_TAG_PROPOGATION_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_EGRESS_TAG_PROPOGATION_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_EGRESS_TAG_PROPOGATION_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_EGRESS_TAG_PROPOGATION_SET, SW_TAG_PROPOGATION, sizeof(fal_tag_propagation_t), SW_PARAM_PTR|SW_PARAM_IN, "egress tag propogation"),

#define SW_API_PT_EGRESS_TAG_PROPOGATION_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_EGRESS_TAG_PROPOGATION_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_EGRESS_TAG_PROPOGATION_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_EGRESS_TAG_PROPOGATION_GET, SW_TAG_PROPOGATION, sizeof(fal_tag_propagation_t), SW_PARAM_PTR|SW_PARAM_OUT, "egress tag propogation"),

#define SW_API_PT_EGRESS_DEFAULT_VID_SET_DESC \
    SW_PARAM_DEF( SW_API_PT_EGRESS_DEFAULT_VID_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF( SW_API_PT_EGRESS_DEFAULT_VID_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF( SW_API_PT_EGRESS_DEFAULT_VID_SET, SW_EGRESS_DEFAULT_VID, sizeof(fal_port_egress_default_vid_t), SW_PARAM_PTR|SW_PARAM_IN, "egress vid"),

#define SW_API_PT_EGRESS_DEFAULT_VID_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_EGRESS_DEFAULT_VID_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),    \
    SW_PARAM_DEF(SW_API_PT_EGRESS_DEFAULT_VID_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),   \
    SW_PARAM_DEF(SW_API_PT_EGRESS_DEFAULT_VID_GET, SW_EGRESS_DEFAULT_VID, sizeof(fal_port_egress_default_vid_t), SW_PARAM_PTR|SW_PARAM_OUT, "egress vid"),
...
#define SW_API_FDB_PT_NEWADDR_LEARN_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_PT_NEWADDR_LEARN_SET, SW_ENABLE, 4, SW_PARAM_IN, "NewAddr Learn"),\
    SW_PARAM_DEF(SW_API_FDB_PT_NEWADDR_LEARN_SET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_IN, "NewAddr CMD"),
...
#define SW_API_FDB_PT_NEWADDR_LEARN_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_PT_NEWADDR_LEARN_GET, SW_ENABLE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "NewAddr Learn"),\
    SW_PARAM_DEF(SW_API_FDB_PT_NEWADDR_LEARN_GET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_PTR|SW_PARAM_OUT, "NewAddr CMD"),
...
#define SW_API_FDB_PT_STAMOVE_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_PT_STAMOVE_SET, SW_ENABLE, 4, SW_PARAM_IN, "StaMove Learn"),\
    SW_PARAM_DEF(SW_API_FDB_PT_STAMOVE_SET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_IN, "StaMove CMD"),
...
#define SW_API_FDB_PT_STAMOVE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_PT_STAMOVE_GET, SW_ENABLE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "StaMove Learn"),\
    SW_PARAM_DEF(SW_API_FDB_PT_STAMOVE_GET, SW_MACCMD, sizeof(fal_fwd_cmd_t), SW_PARAM_PTR|SW_PARAM_OUT, "StaMove CMD"),

#define SW_API_FDB_AGE_MODE_SET_DESC \
    SW_PARAM_DEF(SW_API_FDB_AGE_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_AGE_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Age Mode"),

#define SW_API_FDB_AGE_MODE_GET_DESC \
    SW_PARAM_DEF(SW_API_FDB_AGE_MODE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_AGE_MODE_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Age Mode"),
...
#define SW_API_FDB_LEARN_CTRL_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_SET, SW_ENABLE, 4, SW_PARAM_IN, "Learn Control"),

#define SW_API_FDB_LEARN_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_LEARN_CTRL_GET, SW_ENABLE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Learn Control"),

#define SW_API_FDB_LEARN_MODE_SET_DESC \
    SW_PARAM_DEF(SW_API_FDB_LEARN_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_LEARN_MODE_SET, SW_UINT32, 4, SW_PARAM_IN, "Learn Mode"),

#define SW_API_FDB_LEARN_MODE_GET_DESC \
    SW_PARAM_DEF(SW_API_FDB_LEARN_MODE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_FDB_LEARN_MODE_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Learn Mode"),
...
#define SW_API_IN_MIRROR_ANALY_PT_SET_DESC \
    SW_PARAM_DEF(SW_API_IN_MIRROR_ANALY_PT_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_IN_MIRROR_ANALY_PT_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),

#define SW_API_IN_MIRROR_ANALY_PT_GET_DESC \
    SW_PARAM_DEF(SW_API_IN_MIRROR_ANALY_PT_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_IN_MIRROR_ANALY_PT_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Port ID"),

#define SW_API_EG_MIRROR_ANALY_PT_SET_DESC \
    SW_PARAM_DEF(SW_API_EG_MIRROR_ANALY_PT_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_EG_MIRROR_ANALY_PT_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),

#define SW_API_EG_MIRROR_ANALY_PT_GET_DESC \
    SW_PARAM_DEF(SW_API_EG_MIRROR_ANALY_PT_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_EG_MIRROR_ANALY_PT_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Port ID"),
...
#define SW_API_PPPOE_SESSION_TABLE_DEL_DESC \
    ...
    SW_PARAM_DEF(SW_API_PPPOE_SESSION_TABLE_DEL, SW_PPPOE_LESS,  sizeof(fal_pppoe_session_t), SW_PARAM_PTR|SW_PARAM_IN, "Session"),

#define SW_API_PPPOE_SESSION_TABLE_GET_DESC \
    SW_PARAM_DEF(SW_API_PPPOE_SESSION_TABLE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PPPOE_SESSION_TABLE_GET, SW_PPPOE_LESS,  sizeof(fal_pppoe_session_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "Session"),
...
#define SW_API_IP_NETWORK_ROUTE_SET_DESC \
    SW_PARAM_DEF(SW_API_IP_NETWORK_ROUTE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_IP_NETWORK_ROUTE_SET, SW_UINT32, 4, SW_PARAM_IN, "Index"), \
    SW_PARAM_DEF(SW_API_IP_NETWORK_ROUTE_SET, SW_IP_NETWORK_ROUTE, sizeof(fal_network_route_entry_t), SW_PARAM_PTR|SW_PARAM_IN, "NetworkRoute"),
...
#define SW_API_IP_PUB_IP_ADD_DESC \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_ADD, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_ADD, SW_IP_PUB, sizeof(fal_ip_pub_addr_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "PubAdd"),

#define SW_API_IP_PUB_IP_DEL_DESC \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_DEL, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_DEL, SW_UINT32, 4, SW_PARAM_IN, "entry_id"),

#define SW_API_IP_PUB_IP_GET_DESC \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_IP_PUB_IP_GET, SW_IP_PUB, sizeof(fal_ip_pub_addr_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "PubGet"),
...
#define SW_API_IP_PORT_ARP_SG_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_IP_PORT_ARP_SG_GET, SW_ARP_SG_CFG, sizeof(fal_arp_sg_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "portArpSg"),
...
#define SW_API_IP_PORT_ARP_SG_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_IP_PORT_ARP_SG_SET, SW_ARP_SG_CFG, sizeof(fal_arp_sg_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "portArpSg"),
...
#define SW_API_IP_VSI_MC_MODE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_IP_VSI_MC_MODE_GET, SW_IP_MCMODE, sizeof(fal_mc_mode_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "mcmode"),
...
#define SW_API_IP_VSI_MC_MODE_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_IP_VSI_MC_MODE_SET, SW_IP_MCMODE, sizeof(fal_mc_mode_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "mcmode"),

#define SW_API_GLOBAL_CTRL_SET_DESC \
    SW_PARAM_DEF(SW_API_GLOBAL_CTRL_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_GLOBAL_CTRL_SET, SW_IP_GLOBAL, sizeof(fal_ip_global_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "global"),

#define SW_API_GLOBAL_CTRL_GET_DESC \
    SW_PARAM_DEF(SW_API_GLOBAL_CTRL_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),  \
    SW_PARAM_DEF(SW_API_GLOBAL_CTRL_GET, SW_IP_GLOBAL, sizeof(fal_ip_global_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "global"),
...
#define SW_API_FLOW_CTRL_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FLOW_CTRL_SET, SW_FLOW_CTRL, sizeof(fal_flow_ctrl_t), SW_PARAM_PTR|SW_PARAM_IN, "ctrl"),
...
#define SW_API_FLOW_CTRL_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FLOW_CTRL_GET, SW_FLOW_CTRL, sizeof(fal_flow_ctrl_t), SW_PARAM_PTR|SW_PARAM_OUT, "ctrl"),
...
#define SW_API_TRUNK_FAILOVER_EN_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_TRUNK_FAILOVER_EN_GET, SW_ENABLE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Failover Status"),
...
#define SW_API_PORT_VLAN_VSI_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_PORT_VLAN_VSI_SET, SW_UINT32, 4, SW_PARAM_IN, "VLAN ID"), \
...
#define SW_API_PORT_VLAN_VSI_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_PORT_VLAN_VSI_GET, SW_UINT32, 4, SW_PARAM_IN, "VLAN ID"), \
...
#define SW_API_UCAST_QUEUE_MAP_SET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_MAP_SET, SW_UCAST_QUEUE_MAP, sizeof(fal_ucast_queue_map_t), SW_PARAM_PTR|SW_PARAM_IN, "queue map"),

#define SW_API_UCAST_QUEUE_MAP_GET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_MAP_GET, SW_UCAST_QUEUE_MAP, sizeof(fal_ucast_queue_map_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "queue map"),

#define SW_API_UCAST_PRIORITY_MAP_SET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_PRIORITY_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_PRIORITY_MAP_SET, SW_UCAST_PRI_CLASS, sizeof(fal_ucast_priority_map_t), SW_PARAM_PTR|SW_PARAM_IN, "u pri map"),

#define SW_API_UCAST_PRIORITY_MAP_GET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_PRIORITY_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_PRIORITY_MAP_GET, SW_UCAST_PRI_CLASS, sizeof(fal_ucast_priority_map_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "u pri map"),

#define SW_API_MCAST_PRIORITY_CLASS_SET_DESC \
    SW_PARAM_DEF(SW_API_MCAST_PRIORITY_CLASS_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MCAST_PRIORITY_CLASS_SET, SW_UCAST_PRI_CLASS, sizeof(fal_mcast_priority_map_t), SW_PARAM_PTR|SW_PARAM_IN, "m pri map"),

#define SW_API_MCAST_PRIORITY_CLASS_GET_DESC \
    SW_PARAM_DEF(SW_API_MCAST_PRIORITY_CLASS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MCAST_PRIORITY_CLASS_GET, SW_UCAST_PRI_CLASS, sizeof(fal_mcast_priority_map_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "m pri map"),
...
#define SW_API_QUEUE_FLUSH_DESC \
    ...
    SW_PARAM_DEF(SW_API_QUEUE_FLUSH, SW_QUEUE_FLUSH, sizeof(fal_queue_flush_dst_t), SW_PARAM_PTR|SW_PARAM_IN|SW_PARAM_OUT, "queue flush"),

#define SW_API_UNI_QUEUE_AC_SET_DESC \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_SET, SW_UQUEUE_AC, sizeof(fal_uni_queue_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "uqueue ac"),

#define SW_API_UNI_QUEUE_AC_GET_DESC \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_UNI_QUEUE_AC_GET, SW_UQUEUE_AC, sizeof(fal_uni_queue_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "uqueue ac"),

#define SW_API_MULTI_QUEUE_AC_SET_DESC \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_SET, SW_MQUEUE_AC, sizeof(fal_multi_queue_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "mqueue ac"),

#define SW_API_MULTI_QUEUE_AC_GET_DESC \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Queue ID"), \
    SW_PARAM_DEF(SW_API_MULTI_QUEUE_AC_GET, SW_MQUEUE_AC, sizeof(fal_multi_queue_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "mqueue ac"),

#define SW_API_GROUP_AC_SET_DESC \
    SW_PARAM_DEF(SW_API_GROUP_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_GROUP_AC_SET, SW_UINT32, 4, SW_PARAM_IN, "Group ID"), \
    SW_PARAM_DEF(SW_API_GROUP_AC_SET, SW_GROUP_AC, sizeof(fal_group_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_IN, "group ac"),

#define SW_API_GROUP_AC_GET_DESC \
    SW_PARAM_DEF(SW_API_GROUP_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_GROUP_AC_GET, SW_UINT32, 4, SW_PARAM_IN, "Group ID"), \
    SW_PARAM_DEF(SW_API_GROUP_AC_GET, SW_GROUP_AC, sizeof(fal_group_ac_cfg_t), SW_PARAM_PTR|SW_PARAM_OUT, "group ac"),

#define SW_API_UCAST_HASH_MAP_SET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_HASH_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_HASH_MAP_SET, SW_UCAST_HASH, sizeof(fal_ucast_hash_map_t), SW_PARAM_PTR|SW_PARAM_IN, "ucast hash"),

#define SW_API_UCAST_HASH_MAP_GET_DESC \
    SW_PARAM_DEF(SW_API_UCAST_HASH_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_UCAST_HASH_MAP_GET, SW_UCAST_HASH, sizeof(fal_ucast_hash_map_t), SW_PARAM_PTR|SW_PARAM_OUT, "ucast hash"),
...
#define SW_API_MCAST_QUEUE_MAP_SET_DESC \
    SW_PARAM_DEF(SW_API_MCAST_QUEUE_MAP_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MCAST_QUEUE_MAP_SET, SW_MCAST_QUEUE_MAP, sizeof(fal_mcast_queue_map_t), SW_PARAM_PTR|SW_PARAM_IN, "mcast queue map"),

#define SW_API_MCAST_QUEUE_MAP_GET_DESC \
    SW_PARAM_DEF(SW_API_MCAST_QUEUE_MAP_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_MCAST_QUEUE_MAP_GET, SW_MCAST_QUEUE_MAP, sizeof(fal_mcast_queue_map_t), SW_PARAM_PTR|SW_PARAM_OUT, "mcast queue map"),

#define SW_API_ETHERNET_TYPE_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Ethernet Type"),\
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_SET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_IN, "enable"),

#define SW_API_ETHERNET_TYPE_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Ethernet Type"),\
    SW_PARAM_DEF(SW_API_ETHERNET_TYPE_PROFILE_GET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),

#define SW_API_RFDB_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_SET, SW_MACADDR, sizeof(fal_mac_addr_t), SW_PARAM_PTR|SW_PARAM_IN, "Address"),\
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_SET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_IN, "enable"),

#define SW_API_RFDB_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_GET, SW_MACADDR, sizeof(fal_mac_addr_t), SW_PARAM_PTR|SW_PARAM_OUT, "Ethernet Type"),\
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_GET, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),

#define SW_API_APP_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_APP_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_APP_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_APP_PROFILE_SET, SW_CTRLPKT_PROFILE, sizeof(fal_ctrlpkt_profile_t), SW_PARAM_PTR|SW_PARAM_IN, "app entry"),

#define SW_API_APP_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_APP_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_APP_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_APP_PROFILE_GET, SW_CTRLPKT_PROFILE, sizeof(fal_ctrlpkt_profile_t), SW_PARAM_PTR|SW_PARAM_OUT, "app entry"),

#define SW_API_PARSE_SERVICE_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_SET, SW_PARSE_SERVICE, sizeof(fal_parse_service_entry_t), SW_PARAM_PTR|SW_PARAM_IN, "parse service entry"),

#define SW_API_PARSE_SERVICE_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_PARSE_SERVICE_PROFILE_GET, SW_PARSE_SERVICE, sizeof(fal_parse_service_entry_t), SW_PARAM_PTR|SW_PARAM_OUT, "parse service entry"),

#define SW_API_INGRESS_SERVICE_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_SET, SW_INGRESS_SERVICE, sizeof(fal_ingress_service_entry_t), SW_PARAM_PTR|SW_PARAM_IN, "ingress service entry"),

#define SW_API_INGRESS_SERVICE_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_INGRESS_SERVICE_PROFILE_GET, SW_INGRESS_SERVICE, sizeof(fal_ingress_service_entry_t), SW_PARAM_PTR|SW_PARAM_OUT, "ingress service entry"),

#define SW_API_EGRESS_SERVICE_PROFILE_SET_DESC \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_SET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_SET, SW_EGRESS_SERVICE, sizeof(fal_egress_service_entry_t), SW_PARAM_PTR|SW_PARAM_IN, "egress service entry"),

#define SW_API_EGRESS_SERVICE_PROFILE_GET_DESC \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_GET, SW_UINT32, 4, SW_PARAM_IN, "Profile ID"), \
    SW_PARAM_DEF(SW_API_EGRESS_SERVICE_PROFILE_GET, SW_EGRESS_SERVICE, sizeof(fal_egress_service_entry_t), SW_PARAM_PTR|SW_PARAM_OUT, "egress service entry"),
