...
#define SW_API_DEBUG_PORT_COUNTER_ENABLE_DESC \
    ...
    SW_PARAM_DEF(SW_API_DEBUG_PORT_COUNTER_ENABLE, SW_DEBUG_COUNTER_EN, sizeof(fal_counter_en_t), SW_PARAM_PTR|SW_PARAM_IN, "enable"),
...
#define SW_API_DEBUG_PORT_COUNTER_STATUS_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_DEBUG_PORT_COUNTER_STATUS_GET, SW_DEBUG_COUNTER_EN, sizeof(fal_counter_en_t), SW_PARAM_PTR|SW_PARAM_OUT, "enable"),
...
#define SW_API_DBG_PSGMII_SELF_TEST_DESC \
    ...
    SW_PARAM_DEF(SW_API_DBG_PSGMII_SELF_TEST, SW_ENABLE, sizeof(a_bool_t), SW_PARAM_IN, "enable"),\
