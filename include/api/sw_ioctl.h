...
#define SW_API_PT_MTU_SET  (74 + SW_API_PORT_OFFSET)
#define SW_API_PT_MTU_GET  (75 + SW_API_PORT_OFFSET)
#define SW_API_PT_MRU_SET  (76 + SW_API_PORT_OFFSET)
#define SW_API_PT_MRU_GET  (77 + SW_API_PORT_OFFSET)
#define SW_API_PT_SOURCE_FILTER_GET (78 + SW_API_PORT_OFFSET)
#define SW_API_PT_SOURCE_FILTER_SET (79 + SW_API_PORT_OFFSET)
...
#define SW_API_PT_INGRESS_FILTER_SET (54  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_INGRESS_FILTER_GET (55  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_INGRESS_DEFAULT_TAG_SET (56  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_INGRESS_DEFAULT_TAG_GET (57  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_TAG_PROPOGATION_SET (58  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_TAG_PROPOGATION_GET (59  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_TAG_EGVLANMODE_SET (60  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_TAG_EGVLANMODE_GET (61  + SW_API_PORTVLAN_OFFSET)
...
#define SW_API_PT_EGRESS_TAG_PROPOGATION_SET (64  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_EGRESS_TAG_PROPOGATION_GET (65  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_EGRESS_DEFAULT_VID_SET (66  + SW_API_PORTVLAN_OFFSET)
#define SW_API_PT_EGRESS_DEFAULT_VID_GET (67  + SW_API_PORTVLAN_OFFSET)
...
#define SW_API_FDB_PT_NEWADDR_LEARN_SET    (44  + SW_API_FDB_OFFSET)
#define SW_API_FDB_PT_NEWADDR_LEARN_GET    (45  + SW_API_FDB_OFFSET)
#define SW_API_FDB_PT_STAMOVE_SET          (46  + SW_API_FDB_OFFSET)
#define SW_API_FDB_PT_STAMOVE_GET          (47  + SW_API_FDB_OFFSET)
...
#define SW_API_PT_DHCP_SET            (16  + SW_API_MISC_OFFSET)
#define SW_API_PT_DHCP_GET            (17  + SW_API_MISC_OFFSET)
#define SW_API_ARP_CMD_SET            (18  + SW_API_MISC_OFFSET)
#define SW_API_ARP_CMD_GET            (19  + SW_API_MISC_OFFSET)
#define SW_API_EAPOL_CMD_SET          (20  + SW_API_MISC_OFFSET)
#define SW_API_EAPOL_CMD_GET          (21  + SW_API_MISC_OFFSET)
#define SW_API_EAPOL_STATUS_SET       (22  + SW_API_MISC_OFFSET)
#define SW_API_EAPOL_STATUS_GET       (23  + SW_API_MISC_OFFSET)
#define SW_API_RIPV1_STATUS_SET       (24  + SW_API_MISC_OFFSET)
#define SW_API_RIPV1_STATUS_GET       (25  + SW_API_MISC_OFFSET)
#define SW_API_PT_ARP_REQ_STATUS_SET         (26  + SW_API_MISC_OFFSET)
#define SW_API_PT_ARP_REQ_STATUS_GET         (27  + SW_API_MISC_OFFSET)
#define SW_API_PT_ARP_ACK_STATUS_SET         (28  + SW_API_MISC_OFFSET)
#define SW_API_PT_ARP_ACK_STATUS_GET         (29  + SW_API_MISC_OFFSET)
#define SW_API_INTR_MASK_SET                (30  + SW_API_MISC_OFFSET)
#define SW_API_INTR_MASK_GET                (31  + SW_API_MISC_OFFSET)
#define SW_API_INTR_STATUS_GET              (32  + SW_API_MISC_OFFSET)
#define SW_API_INTR_STATUS_CLEAR            (33  + SW_API_MISC_OFFSET)
#define SW_API_INTR_PORT_LINK_MASK_SET      (34  + SW_API_MISC_OFFSET)
#define SW_API_INTR_PORT_LINK_MASK_GET      (35  + SW_API_MISC_OFFSET)
#define SW_API_INTR_PORT_LINK_STATUS_GET    (36  + SW_API_MISC_OFFSET)
#define SW_API_INTR_MASK_MAC_LINKCHG_SET      (37  + SW_API_MISC_OFFSET)
#define SW_API_INTR_MASK_MAC_LINKCHG_GET      (38  + SW_API_MISC_OFFSET)
#define SW_API_INTR_STATUS_MAC_LINKCHG_GET    (39  + SW_API_MISC_OFFSET)
#define SW_API_INTR_STATUS_MAC_LINKCHG_CLEAR    (40 + SW_API_MISC_OFFSET)
#define SW_API_CPU_VID_EN_SET      (41  + SW_API_MISC_OFFSET)
#define SW_API_CPU_VID_EN_GET    (42  + SW_API_MISC_OFFSET)
#define SW_API_GLOBAL_MACADDR_SET      (43  + SW_API_MISC_OFFSET)
#define SW_API_GLOBAL_MACADDR_GET    (44  + SW_API_MISC_OFFSET)
#define SW_API_LLDP_STATUS_SET          (45  + SW_API_MISC_OFFSET)
#define SW_API_LLDP_STATUS_GET          (46  + SW_API_MISC_OFFSET)
#define SW_API_FRAME_CRC_RESERVE_SET          (47  + SW_API_MISC_OFFSET)
#define SW_API_FRAME_CRC_RESERVE_GET          (48  + SW_API_MISC_OFFSET)
...
#define SW_API_IP_NETWORK_ROUTE_SET    (48  + SW_API_IP_OFFSET)
...
#define SW_API_IP_PUB_IP_ADD    (59  + SW_API_IP_OFFSET)
#define SW_API_IP_PUB_IP_GET    (60  + SW_API_IP_OFFSET)
#define SW_API_IP_PUB_IP_DEL    (61  + SW_API_IP_OFFSET)
...
#define SW_API_UCAST_QUEUE_MAP_SET         (0  + SW_API_QM_OFFSET)
#define SW_API_UCAST_QUEUE_MAP_GET         (1  + SW_API_QM_OFFSET)
#define SW_API_UCAST_PRIORITY_MAP_SET         (2  + SW_API_QM_OFFSET)
#define SW_API_UCAST_PRIORITY_MAP_GET         (3  + SW_API_QM_OFFSET)
#define SW_API_MCAST_PRIORITY_CLASS_SET         (4  + SW_API_QM_OFFSET)
#define SW_API_MCAST_PRIORITY_CLASS_GET         (5  + SW_API_QM_OFFSET)
#define SW_API_QUEUE_FLUSH         (6  + SW_API_QM_OFFSET)
#define SW_API_UNI_QUEUE_AC_SET         (7  + SW_API_QM_OFFSET)
#define SW_API_UNI_QUEUE_AC_GET         (8  + SW_API_QM_OFFSET)
#define SW_API_MULTI_QUEUE_AC_SET         (9  + SW_API_QM_OFFSET)
#define SW_API_MULTI_QUEUE_AC_GET         (10  + SW_API_QM_OFFSET)
#define SW_API_GROUP_AC_SET         (11  + SW_API_QM_OFFSET)
#define SW_API_GROUP_AC_GET         (12 + SW_API_QM_OFFSET)
#define SW_API_UCAST_HASH_MAP_SET         (13  + SW_API_QM_OFFSET)
#define SW_API_UCAST_HASH_MAP_GET         (14 + SW_API_QM_OFFSET)
#define SW_API_UCAST_DFLT_HASH_MAP_SET         (15  + SW_API_QM_OFFSET)
#define SW_API_UCAST_DFLT_HASH_MAP_GET         (16+ SW_API_QM_OFFSET)
#define SW_API_MCAST_QUEUE_MAP_SET         (17  + SW_API_QM_OFFSET)
#define SW_API_MCAST_QUEUE_MAP_GET         (18  + SW_API_QM_OFFSET)
...
#define SW_API_PPPOE_CMD_GET          (1  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_STATUS_SET       (2  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_STATUS_GET       (3  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_ADD      (4  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_DEL      (5  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_GET      (6  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_TABLE_ADD      (7  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_TABLE_DEL      (8  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_TABLE_GET      (9  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_ID_SET         (10  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_SESSION_ID_GET         (11  + SW_API_PPPOE_OFFSET)
#define SW_API_RTD_PPPOE_EN_SET             (12  + SW_API_PPPOE_OFFSET)
#define SW_API_RTD_PPPOE_EN_GET             (13  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_EN_SET                 (14  + SW_API_PPPOE_OFFSET)
#define SW_API_PPPOE_EN_GET                 (15  + SW_API_PPPOE_OFFSET)

    /* Ctrlpkt Control */
#define SW_API_CTRLPKT_OFFSET        2500
#define SW_API_ETHERNET_TYPE_PROFILE_SET   (0  + SW_API_CTRLPKT_OFFSET)
#define SW_API_ETHERNET_TYPE_PROFILE_GET   (1  + SW_API_CTRLPKT_OFFSET)
#define SW_API_RFDB_PROFILE_SET     (2  + SW_API_CTRLPKT_OFFSET)
#define SW_API_RFDB_PROFILE_GET     (3  + SW_API_CTRLPKT_OFFSET)
#define SW_API_APP_PROFILE_SET     (4  + SW_API_CTRLPKT_OFFSET)
#define SW_API_APP_PROFILE_GET     (5  + SW_API_CTRLPKT_OFFSET)

    /* Ctrlpkt Control */
#define SW_API_SERVCODE_OFFSET        2600
#define SW_API_PARSE_SERVICE_PROFILE_SET   (0  + SW_API_SERVCODE_OFFSET)
#define SW_API_PARSE_SERVICE_PROFILE_GET   (1  + SW_API_SERVCODE_OFFSET)
#define SW_API_INGRESS_SERVICE_PROFILE_SET     (2  + SW_API_SERVCODE_OFFSET)
#define SW_API_INGRESS_SERVICE_PROFILE_GET     (3  + SW_API_SERVCODE_OFFSET)
#define SW_API_EGRESS_SERVICE_PROFILE_SET     (4  + SW_API_SERVCODE_OFFSET)
#define SW_API_EGRESS_SERVICE_PROFILE_GET     (5  + SW_API_SERVCODE_OFFSET)
