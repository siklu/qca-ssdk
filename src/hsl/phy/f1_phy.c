...
static int f1_phy_probe(a_uint32_t dev_id, struct phy_device *pdev)
{
	int ret;
	...
	ret = hsl_phy_api_ops_register(dev_id, &f1_phy_api_ops);
...
int f1_phy_init(a_uint32_t dev_id)
{
	...
	return f1_phy_probe(dev_id, (struct phy_device *)NULL);
}
